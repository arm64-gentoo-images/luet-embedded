...
Can boot to other drives afte runing boot menu , else grub-aarch64 or grub-arm32.efi 
rpi4 will soon have vulkan drivers so runing boot splash ie grub/plmouth posibilities...

also less hell if gentoo, funtoo, etc are on usb ssd's and or if a multiboard uefi image 
